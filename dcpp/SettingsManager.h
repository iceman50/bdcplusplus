...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		ACFRAME_ORDER, ACFRAME_WIDTHS, BDCFRAME_ORDER, BDCFRAME_WIDTHS, INFO_VIEWER_FONT,
		//
		STR_LAST };
	...
	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		...
		FILTER_MESSAGES,
		FINISHED_DL_ONLY_FULL, FOLLOW_LINKS, GET_USER_COUNTRY, GET_USER_INFO,
