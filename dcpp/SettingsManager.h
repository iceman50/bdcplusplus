...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		INFO_VIEWER_FONT, ACFRAME_ORDER, ACFRAME_WIDTHS, LOADED_THEME, THEME_DIRECTORY, ICONS_DIRECTORY,
		BDCFRAME_ORDER, BDCFRAME_WIDTHS,
		//
		STR_LAST };
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		//DiCe addon SETTINGS::INT
		ACTION_DOUBLECLICK_USER,
	...
	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		...
		MAGNET_REGISTER, MINIMIZE_TRAY, NO_AWAYMSG_TO_BOTS, NO_IP_OVERRIDE, NO_IP_OVERRIDE6,
		...
		TABS_ON_BOTTOM, AC_DISCLAIM, USE_THEME, ENABLE_NMDC_TLS, ENABLE_SUDP,
		BOOL_LAST };
